...
```bash
python scripts/transformers/transformers_file_issues.py {issue_bodies_dir.parent / (issue_bodies_dir.parent.stem + "-new.json")} \\
...
def main():
    ...
    print("3. File issues: python scripts/transformers/transformers_file_issues.py ...")
    print()
