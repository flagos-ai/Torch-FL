...
def main():
    ...
    if all_cuda:
        ...
        # safely. mul_.Tensor is not safe despite the out=A exit: measured
        # NotImplementedError on flagos (gems mul_broadcast_func re-enters
        # torch.mul and hits the PrivateUse1 fallback).
