...
BOXING_GAP_NOTES = {
    ...
    "ppu": (
        "43 of the 482 FlagGems-covered ops are pinned to cuda; the other 439",
        ...
        "2026-09-15 overload survey's measured route-dependent failures. The",
        "last six came from the CI steps that survey cannot see: the addmm",
        "family, whose autotune picks a BLOCK_SIZE_K < 16 config on small-K",
        "shapes that the ppu triton rejects in tl.dot, and _conj, which",
        "FlagGems materializes instead of setting the Conjugate bit. See",
