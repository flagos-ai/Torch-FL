...
behaviour move. Ascend, MUSA, DCU, MetaX, PPU and Tsingmicro are therefore
unaffected rather than unvalidated. The FlagGems-route change is GCU-only.
