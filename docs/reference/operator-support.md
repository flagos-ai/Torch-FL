...
**Route delta.** GCU `flaggems` stays **248**, `gcu` 171 -> **176**, `none` 1610 ->
**1605**, over the same 2036 routable ops, so accelerated routes go 426 -> **431**
...
|---|---|---|
| `torch_fl/configs/backends_gcu.conf` | `293fe0e27f75ab6691c65228957cc3b3b7183995261be4d632460c6071788153` | `61d9a8de312f38bde999dee01e9b3609d59953b8d3a8357cb87cc2955576c648` |
